...
export default function AboutSection() {
  return (
    <section id="about-me" style={{ background: "var(--page-bg)", padding: "100px 80px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <ScrollReveal variant="fadeUp">
          <SectionHeader title="About Me" subtitle="User Interface And User Experience And Also Adobe Editing" />
        </ScrollReveal>

        <div style={{ display: "flex", gap: "80px", alignItems: "flex-start", marginTop: "30px" }}>
          {/* Image */}
          <ScrollReveal variant="fadeRight" delay={0.1} style={{ flex: "0 0 320px" }}>
            <div style={{ width: "320px", height: "420px", background: "linear-gradient(145deg, var(--surface-bg), var(--surface-bg-alt))", border: "1px solid var(--border-color)", clipPath: "polygon(0 0, 85% 0, 100% 15%, 100% 100%, 0 100%)", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", gap: "100px", marginTop: "50px", flexWrap: "wrap", marginLeft: "140px"  }}>
          {SKILLS.map((skill, i) => (
